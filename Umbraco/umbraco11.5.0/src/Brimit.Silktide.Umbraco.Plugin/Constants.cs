namespace Brimit.Silktide.Plugin
{
    public class SilktideConstants
    {
        ...
        public const string SilktidePluginFolder = "/App_Plugins/Brimit.Silktide.Umbraco.Plugin/";
        public const string SilktidePluginFolderWindowsPath = "App_Plugins\\Brimit.Silktide.Umbraco.Plugin\\";
        ...
        public const string DefaultRemoteHost = "https://api.silktide.com/cms/update";
